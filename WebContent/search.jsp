...
<head>
      ...
      <script type="text/javascript">
         ...
         function playsong(data) { // 팝업창 띄우는 함수 
            ...
            event.preventDefault(); // a 하이퍼링크 이동을 취소시켜주는 함수
         } 
         function save(number) {
            var num = $('[name='+number+']').is(':checked');
            if(num == true){
               alert($("tr.song-list"+number+" > td.title > span").text());
            }else{
               alert("체크안됌");
            }
...
<body style="height: 100%; margin: 0; padding: 0;">
      ...
      <div id = "middle">
         <div id = "album">
            <h2>검색 결과</h2>
            <div id="current" style="margin-right: 35px;">
               <ul>
         ...
         <a href="SongSearch.jsp?search=<%= query %>" style="float: right; text-decoration: none; color: black;">
            곡  결과 더보기>>
         </a>
         ...
         <hr class="hr" color="blue">
         <a href="AlbumSearch.jsp?search=<%= query %>" style="float: right; text-decoration: none; color: black;">
            앨범  결과 더보기>>
         </a>
         <h2>앨범</h2>
         <table border="2" style="width: 700px; height: 500px; position: absolute;">
            ...
            %>
               ...
               <td class="albumpage"><a href="Album.jsp"><%= albumimg %></a></td>
      ...
      <div id="hotsearch" style="left: 700px;">
         <table>
            <tr>인기검색어<br>
            </tr>
            <!-- 인기검색어 가져오기 -->
      ...
      <div id = "under" style="position: absolute; top: 1500px;">
